...
const contact = () => {
    return (
        <div>
            ...
            <div className="bg-white px-6 py-15 sm:py-20 lg:px-8">
                ...
                <form action="#" method="POST" className="mx-auto mt-10 max-w-xl sm:mt-10">
                    <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                        ...
                        <div className="sm:col-span-2">
                            <label htmlFor="company" className="block text-sm font-semibold leading-6 text-gray-900"> Transplant center, organ procurement organization, or other transplant society/committee:
                            </label>
                            <div className="mt-2.5">
                        ...
                        <div className="sm:col-span-2">
                            ...
                            <div className="relative mt-2.5">
                                ...
                                <input type="tel" name="phone-number" id="phone-number" autoComplete="tel" className="block w-full rounded-md border-0 px-2 py-2 pl-14 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-l sm:leading-6" />
                            </div>
                        </div>
                        <div className="sm:col-span-2">
                    ...
                    <div className="mt-10">
                        <button type="submit" className="block w-full rounded-md bg-gray-400 px-3.5 py-2.5 text-center text-xl font-semibold text-gray-800 shadow-sm hover:bg-gray-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-600">Write To Us</button>
                    </div>
                    <div className='mt-10 leading-9'>
                        ...
                        <div className='leading-6'>
                            ...
                            Office of the Joint Director (Medical)
                            Arogya soudha 6th floor,
